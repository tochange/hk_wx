...
!function(e, o) {
    ...
    return w.prototype.init = function() {
        ...
        void 0 === d && (d = r);
        var s = i.height;
        void 0 === s && (s = a), t.throttle = function(t, e, o) {
            var n = null, r = new Date();
            return function() {
                var a = this, i = arguments, c = new Date();
                clearTimeout(n), c - r >= o ? (t.apply(a, i), r = c) : n = setTimeout(function() {
                    t.apply(a, i);
                }, e);
            };
        }, t.updateCanvas = t.throttle(function() {
            ...
            t;
        }, 100, 300), t.pushOrign = function(o) {
